"""Unit tests for the quality check CLI interface.
...
from src.quality_check import build_parser, main


class TestQualityCheckCli(unittest.TestCase):
...
self -- The self."""
        ...
        self.assertIn("--report-dir", help_text)
