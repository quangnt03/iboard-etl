...
self -- The self."""
        ...
        # Load the named SQL block and execute it against SQLite.
...
name -- Identifier following the `-- name:` marker."""
        ...
        # Extract the named query section using a marker pattern.
...
Keyword arguments:
sql_path -- The sql path."""

    # Reuse the shared SQLite connection manager.
